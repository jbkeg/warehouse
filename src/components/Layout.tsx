  ...
  const menuSections = [
    {
      ...
      label: 'Dashboard',
      items: [
        { id: 'dashboard', label: 'Home', href: '/', icon: 'ri-home-smile-line' },
      ]
    },
    {
      id: 'operations',
      ...
      items: [
        { id: 'inbound', label: 'Receiving', href: '/inbound', icon: 'ri-truck-line', badge: '12' },
        { id: 'inventory', label: 'Stock Check', href: '/inventory', icon: 'ri-stack-line' },
        { id: 'outbound', label: 'Orders', href: '/outbound', icon: 'ri-shopping-cart-2-line', badge: '8' },
        { id: 'qr-scanner', label: 'QR Scanner', href: '/qr-scanner', icon: 'ri-qr-scan-2-line' },
        { id: 'picking', label: 'Pick Items', href: '/picking', icon: 'ri-hand-heart-line', badge: '5' },
        { id: 'packing', label: 'Pack Orders', href: '/packing', icon: 'ri-gift-line', badge: '3' },
      ]
    },
    {
      id: 'materials',
      ...
      items: [
        { id: 'subsidiary-materials', label: 'Subsidiary Materials', href: '/subsidiary-materials', icon: 'ri-box-2-line', badge: '4' },
      ]
    },
    {
      id: 'support',
      label: 'Customer Care',
      items: [
        { id: 'cs', label: 'Support Center', href: '/cs', icon: 'ri-customer-service-2-line', badge: '3' },
        { id: 'tickets', label: 'Help Desk', href: '/tickets', icon: 'ri-question-answer-line' },
      ]
    },
    {
      id: 'analytics',
      ...
      items: [
        { id: 'reports', label: 'Reports', href: '/reports', icon: 'ri-file-chart-line' },
        { id: 'analytics', label: 'Analytics', href: '/analytics', icon: 'ri-pie-chart-line' },
        { id: 'performance', label: 'Performance', href: '/performance', icon: 'ri-rocket-line' },
      ]
    },
    {
      id: 'management',
      ...
      items: [
        ...
        { id: 'suppliers', label: 'Suppliers', href: '/suppliers', icon: 'ri-building-line' },
        { id: 'settings', label: 'Settings', href: '/settings', icon: 'ri-settings-4-line' },
      ]
    }
  ];
          ...
          {menuSections.map((section) => (
            <div key={section.id} className="mb-6">
              ...
              >
                ...
                <i className={`ri-arrow-${expandedSections.includes(section.id) ? 'up' : 'down'}-s-line w-4 h-4 flex items-center justify-center transform transition-transform duration-200`}></i>
              </button>
                  ...
                  {section.items.map((item) => (
                    <Link
                      ...
                      className={`flex items-center justify-between px-4 py-3 mx-2 text-sm text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 hover:text-blue-700 transition-all duration-200 rounded-lg group ${
                        activeMenu === item.id ? 'bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 shadow-sm border-l-4 border-blue-500' : ''
                      }`}
                      onClick={() => setActiveMenu(item.id)}
                    >
                      <div className="flex items-center space-x-3">
                        <i className={`${item.icon} w-5 h-5 flex items-center justify-center group-hover:scale-110 transition-transform duration-200`}></i>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <div>
                ...
                <p className="text-sm text-gray-600">Ready to manage your warehouse efficiently</p>
              </div>
